...
var mixinContainer = function mixinContainer(React) {
  var cloneElement = function cloneElement(element, props) {
    return React.createElement(element.type, (0, _object["default"])({}, element.props, props, {
  ...
  return {
    ...
    reduceState: function reduceState(props) {
      return (0, _object["default"])({}, this.getStateFromStores(props), this.getStateFromActions(props), this.getInjected(props));
    },
    ...
    altRender: function altRender(Node) {
      ...
      if (Array.isArray(children)) {
        return React.createElement(Node, null, children.map(function (child, i) {
          return cloneElement(child, (0, _object["default"])({
            key: i
          }, _this2.getProps()));
        }, this));
      } else if (children) {
